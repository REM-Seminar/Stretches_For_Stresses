...
public class LowerBody extends AppCompatActivity implements ListViewAdapter.OnStretchListener {
    ...
    private void queryStretches() {
        ...
        query.whereEqualTo("type", "LowerBody");
